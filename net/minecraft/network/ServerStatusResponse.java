    ...
    JsonSerializer<ServerStatusResponse> {
        ...
        public ServerStatusResponse deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            if (jsonobject.has("description")) {
                serverstatusresponse.setServerDescription((IChatComponent)p_deserialize_3_.deserialize(jsonobject.get("description"), (Type)((Object)IChatComponent.class)));
            }
            if (jsonobject.has("players")) {
                serverstatusresponse.setPlayerCountData((PlayerCountData)p_deserialize_3_.deserialize(jsonobject.get("players"), (Type)((Object)PlayerCountData.class)));
            }
            if (jsonobject.has("version")) {
                serverstatusresponse.setProtocolVersionInfo((MinecraftProtocolVersionIdentifier)p_deserialize_3_.deserialize(jsonobject.get("version"), (Type)((Object)MinecraftProtocolVersionIdentifier.class)));
            }
