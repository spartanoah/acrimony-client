    ...
    extends Piece {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            block3: for (RoomDefinition structureoceanmonumentpieces$roomdefinition : list) {
                ...
                for (MonumentRoomFitHelper monumentRoomFitHelper : list1) {
                    if (!monumentRoomFitHelper.func_175969_a(structureoceanmonumentpieces$roomdefinition)) continue;
                    this.field_175843_q.add(monumentRoomFitHelper.func_175968_a(this.coordBaseMode, structureoceanmonumentpieces$roomdefinition, p_i45599_1_));
                    continue block3;
                }
            }
            ...
            this.field_175843_q.add(new WingRoom(this.coordBaseMode, structureBoundingBox, i++));
        ...
        private List<RoomDefinition> func_175836_a(Random p_175836_1_) {
            ...
            for (int i = 0; i < 5; ++i) {
                for (int j = 0; j < 4; ++j) {
                    int k = 0;
                    int l = MonumentBuilding.func_175820_a(i, k, j);
            ...
            for (int i2 = 0; i2 < 5; ++i2) {
                for (int l2 = 0; l2 < 4; ++l2) {
                    int k3 = 1;
                    int j4 = MonumentBuilding.func_175820_a(i2, k3, l2);
                ...
                for (int j3 = 0; j3 < 5; ++j3) {
                    for (int i4 = 0; i4 < 3; ++i4) {
                        ...
                        for (EnumFacing enumfacing : EnumFacing.values()) {
                            ...
                            if (i1 < 0 || i1 >= 5 || k1 < 0 || k1 >= 5 || j1 < 0 || j1 >= 3 || astructureoceanmonumentpieces$roomdefinition[l1 = MonumentBuilding.func_175820_a(i1, j1, k1)] == null) continue;
                            if (k1 != j3) {
    ...
    extends StructureComponent {
        ...
        protected boolean func_175817_a(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
            ...
            if (p_175817_2_.isVecInside(new BlockPos(i, j = this.getYWithOffset(p_175817_4_), k = this.getZWithOffset(p_175817_3_, p_175817_5_)))) {
                ...
                entityguardian.setLocationAndAngles((double)i + 0.5, j, (double)k + 0.5, 0.0f, 0.0f);
