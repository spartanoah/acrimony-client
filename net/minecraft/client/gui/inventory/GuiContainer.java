...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        double percentage = AnimationUtil.getPercentage(animationDuration, this.openTime) / 100.0;
        CustomGui customGui = Acrimony.instance.getModuleManager().getModule(CustomGui.class);
        if (customGui.isEnabled()) {
            switch (CustomGui.guiContainerAnimation.getMode()) {
                case "Scale": {
                    if (!(percentage < 1.0)) break;
                    GlStateManager.translate(this.width / 2, this.height / 2, 0.0f);
                    GlStateManager.scale(percentage, percentage, 0.0);
                    GlStateManager.translate(-(this.width / 2), -(this.height / 2), 0.0f);
                    break;
                }
                case "Slide": {
                    ...
                    if (!(percentage < 1.0)) break;
                    GlStateManager.translate(0.0, (double)(this.guiTop + 170) + -AnimationUtil.getDoubleFromPercentage(percentage * 100.0, this.guiTop + 170), 0.0);
                }
            }
        }
        int i = this.guiLeft;
