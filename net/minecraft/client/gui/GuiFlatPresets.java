...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_) {
            ...
            worldrenderer.func_181662_b(p_148171_1_ + 0, p_148171_2_ + 18, GuiFlatPresets.this.zLevel).func_181673_a((float)(p_148171_3_ + 0) * 0.0078125f, (float)(p_148171_4_ + 18) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_ + 18, p_148171_2_ + 18, GuiFlatPresets.this.zLevel).func_181673_a((float)(p_148171_3_ + 18) * 0.0078125f, (float)(p_148171_4_ + 18) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_ + 18, p_148171_2_ + 0, GuiFlatPresets.this.zLevel).func_181673_a((float)(p_148171_3_ + 18) * 0.0078125f, (float)(p_148171_4_ + 0) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_ + 0, p_148171_2_ + 0, GuiFlatPresets.this.zLevel).func_181673_a((float)(p_148171_3_ + 0) * 0.0078125f, (float)(p_148171_4_ + 0) * 0.0078125f).func_181675_d();
            tessellator.draw();
        }
