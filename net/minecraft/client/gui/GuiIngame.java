...
extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Acrimony.instance.getEventManager().post(new Render2DEvent(scaledresolution, partialTicks, scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight()));
        ...
        Acrimony.instance.getEventManager().post(new RenderEvent(partialTicks));
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            this.drawTexturedModalRect(i - 91 - 1 + Acrimony.instance.getSlotSpoofHandler().getSpoofedSlot() * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            this.zLevel = f;
    ...
    private void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.func_181662_b(0.0, p_180474_2_.getScaledHeight(), -90.0).func_181673_a(f, f3).func_181675_d();
        worldrenderer.func_181662_b(p_180474_2_.getScaledWidth(), p_180474_2_.getScaledHeight(), -90.0).func_181673_a(f2, f3).func_181675_d();
        worldrenderer.func_181662_b(p_180474_2_.getScaledWidth(), 0.0, -90.0).func_181673_a(f2, f1).func_181675_d();
        worldrenderer.func_181662_b(0.0, 0.0, -90.0).func_181673_a(f, f1).func_181675_d();
        tessellator.draw();
        GlStateManager.depthMask(true);
        GlStateManager.enableDepth();
        GlStateManager.enableAlpha();
