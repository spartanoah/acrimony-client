    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (this.getEnableBackgroundDrawing()) {
                GuiPasswordField.drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, -6250336);
                GuiPasswordField.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
            }
            i = this.isEnabled ? this.enabledColor : this.disabledColor;
            int j = this.cursorPosition - this.lineScrollOffset;
            int k = this.selectionEnd - this.lineScrollOffset;
            String s = this.fontRendererInstance.trimStringToWidth(hiddenText.substring(this.lineScrollOffset), this.getWidth());
            ...
            boolean flag2 = this.cursorPosition < hiddenText.length() || hiddenText.length() >= this.getMaxStringLength();
            int k1 = j1;
            if (!flag) {
