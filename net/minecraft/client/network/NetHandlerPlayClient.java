...
import Acrimony.event.impl.EntityMoveEvent;
...
implements INetHandlerPlayClient {
    ...
    public void handleEntityMovement(S14PacketEntity packetIn) {
        ...
        if (entity != null) {
            ...
            entity.onGround = packetIn.getOnGround();
            Acrimony.instance.getEventManager().post(new EntityMoveEvent(entity));
        }
    }
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(Acrimony.instance.getMainMenu()), "disconnect.lost", reason));
        }
    }
