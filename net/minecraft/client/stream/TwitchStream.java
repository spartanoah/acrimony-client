...
IStream {
    ...
    public void func_152922_k() {
        if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused()) {
            ...
            if (flag) {
                ...
                worldrenderer.func_181662_b(0.0, f1, 0.0).func_181673_a(0.0, f3).func_181675_d();
                worldrenderer.func_181662_b(f, f1, 0.0).func_181673_a(f2, f3).func_181675_d();
                worldrenderer.func_181662_b(f, 0.0, 0.0).func_181673_a(f2, 0.0).func_181675_d();
    ...
    public void func_152897_a(ErrorCode p_152897_1_) {
        if (ErrorCode.succeeded(p_152897_1_)) {
            ...
            LOGGER.warn(STREAM_MARKER, "Login attempt unsuccessful: {} (error code {})", new Object[]{ErrorCode.getString(p_152897_1_), p_152897_1_.getValue()});
            this.loggedIn = false;
        }
    }
    ...
    public void func_152893_b(ErrorCode p_152893_1_) {
        LOGGER.warn(STREAM_MARKER, "Issue submitting frame: {} (Error code {})", new Object[]{ErrorCode.getString(p_152893_1_), p_152893_1_.getValue()});
