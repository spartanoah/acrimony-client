...
public class ItemCameraTransforms {
    ...
    public void func_181689_a(TransformType p_181689_1_) {
    ...
    public ItemTransformVec3f func_181688_b(TransformType p_181688_1_) {
        switch (p_181688_1_) {
            case THIRD_PERSON: {
    ...
    implements JsonDeserializer<ItemCameraTransforms> {
        ...
        private ItemTransformVec3f func_181683_a(JsonDeserializationContext p_181683_1_, JsonObject p_181683_2_, String p_181683_3_) {
            return p_181683_2_.has(p_181683_3_) ? (ItemTransformVec3f)p_181683_1_.deserialize(p_181683_2_.get(p_181683_3_), (Type)((Object)ItemTransformVec3f.class)) : ItemTransformVec3f.DEFAULT;
        }
    }
}
