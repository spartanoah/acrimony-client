...
extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
            Acrimony.instance.getEventManager().post(new UpdateEvent());
            super.onUpdate();
            if (this.isRiding()) {
                ...
                Acrimony.instance.getEventManager().post(new PostMotionEvent());
            }
        }
    }
    ...
    public void onUpdateWalkingPlayer() {
        ...
        Acrimony.instance.getEventManager().post(actionEvent);
        ...
        if ((flag1 = actionEvent.isSneaking()) != this.serverSneakState) {
            if (flag1) {
        ...
        Acrimony.instance.getEventManager().post(motionEvent);
        if (this.isCurrentViewEntity()) {
            ...
            if (this.ridingEntity == null) {
                ...
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0, this.motionZ, motionEvent.getYaw(), motionEvent.getPitch(), motionEvent.isOnGround()));
                flag2 = false;
            }
    ...
    public void onLivingUpdate() {
        ...
        if (this.onGround && !flag1 && !flag2 && (this.movementInput.moveForward >= f || noslowAllowSprint && this.movementInput.moveForward > 0.1f) && !this.isSprinting() && flag3 && (!this.isUsingItem() || noslowAllowSprint) && !this.isPotionActive(Potion.blindness)) {
        ...
        if (!this.isSprinting() && (this.movementInput.moveForward >= f || noslowAllowSprint && this.movementInput.moveForward > 0.1f) && flag3 && (!this.isUsingItem() || noslowAllowSprint) && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
            this.setSprinting(true);
        }
        if (this.isSprinting() && ((this.movementInput.moveForward < f || this.mc.thePlayer.isUsingItem()) && (!noslowAllowSprint || this.mc.thePlayer.moveForward <= 0.1f) || this.isCollidedHorizontally || !flag3)) {
            this.setSprinting(false);
        }
