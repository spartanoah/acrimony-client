...
IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        Acrimony.instance.start();
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(Acrimony.instance.getMainMenu(), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(Acrimony.instance.getMainMenu());
        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Acrimony.instance.getName() + " " + Acrimony.instance.getVersion());
        try {
    ...
    public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_) {
        ...
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.func_181662_b(p_181536_1_, p_181536_2_ + p_181536_6_, 0.0).func_181673_a((float)p_181536_3_ * f, (float)(p_181536_4_ + p_181536_6_) * f1).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_ + p_181536_5_, p_181536_2_ + p_181536_6_, 0.0).func_181673_a((float)(p_181536_3_ + p_181536_5_) * f, (float)(p_181536_4_ + p_181536_6_) * f1).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_ + p_181536_5_, p_181536_2_, 0.0).func_181673_a((float)(p_181536_3_ + p_181536_5_) * f, (float)p_181536_4_ * f1).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_, p_181536_2_, 0.0).func_181673_a((float)p_181536_3_ * f, (float)p_181536_4_ * f1).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            guiScreenIn = Acrimony.instance.getMainMenu();
        } else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0f) {
            guiScreenIn = new GuiGameOver();
        }
        if (guiScreenIn instanceof GuiMainMenu || guiScreenIn instanceof AcrimonyMenu) {
    ...
    private void runGameLoop() throws IOException {
        ...
        for (int j = 0; j < this.timer.elapsedTicks; ++j) {
            if (Minecraft.getMinecraft().thePlayer != null) {
                Tickbase tickBase;
                boolean skip = false;
                if (j == 0 && (tickBase = Acrimony.instance.getModuleManager().getModule(Tickbase.class)).isEnabled()) {
    ...
    private void displayDebugInfo(long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            worldrenderer.func_181662_b((float)j - (float)i * 1.1f, (float)k - (float)i * 0.6f - 16.0f, 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b((float)j - (float)i * 1.1f, k + i * 2, 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b((float)j + (float)i * 1.1f, k + i * 2, 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b((float)j + (float)i * 1.1f, (float)k - (float)i * 0.6f - 16.0f, 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
            tessellator.draw();
            ...
            for (int l = 0; l < list.size(); ++l) {
                ...
                int l1 = j1 >> 8 & 0xFF;
                int i2 = j1 & 0xFF;
                worldrenderer.func_181662_b(j, k, 0.0).func_181669_b(k1, l1, i2, 255).func_181675_d();
                for (int j2 = i1; j2 >= 0; --j2) {
                    ...
                    worldrenderer.func_181662_b((float)j + f1, (float)k - f2, 0.0).func_181669_b(k1, l1, i2, 255).func_181675_d();
                }
                tessellator.draw();
                ...
                for (int i3 = i1; i3 >= 0; --i3) {
                    ...
                    worldrenderer.func_181662_b((float)j + f4, (float)k - f5, 0.0).func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255).func_181675_d();
                    worldrenderer.func_181662_b((float)j + f4, (float)k - f5 + 10.0f, 0.0).func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255).func_181675_d();
                }
                tessellator.draw();
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                if (this.playerController.isNotCreative() && !Acrimony.instance.getModuleManager().getModule(DelayRemover.class).isEnabled()) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    default: {
                        if (!this.playerController.isNotCreative() || Acrimony.instance.getModuleManager().getModule(DelayRemover.class).isEnabled()) break;
                        this.leftClickCounter = 10;
                    }
                }
            }
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    case BLOCK: {
                        int i;
                        BlockPos blockpos = this.objectMouseOver.getBlockPos();
                        Killaura killauraModule = Acrimony.instance.getModuleManager().getModule(Killaura.class);
                        if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() == Material.air || killauraModule.isEnabled() && killauraModule.getTarget() != null) break;
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            Acrimony.instance.getEventManager().post(new TickEvent());
            ...
            while (Keyboard.next()) {
                ...
                if (this.currentScreen != null) {
                    ...
                    Acrimony.instance.getEventManager().post(new KeyPressEvent(k));
                    if (k == 1) {
