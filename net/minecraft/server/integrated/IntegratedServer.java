    ...
    protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long seed, WorldType type, String p_71247_6_) {
        ...
        if (flag) {
            ...
            for (int l = 0; l < this.worldServers.length; ++l) {
                ...
                if (l == 0) {
                    this.worldServers[l] = this.isDemo() ? (WorldServer)new DemoWorldServer(this, isavehandler, worldinfo, i1, this.theProfiler).init() : (WorldServer)new WorldServer(this, isavehandler, worldinfo, i1, this.theProfiler).init();
