...
public class CustomSkyLayer {
    ...
    private void renderSide(Tessellator tess, int side) {
        ...
        worldrenderer.func_181662_b(-100.0, -100.0, -100.0).func_181673_a(d0, d1).func_181675_d();
        worldrenderer.func_181662_b(-100.0, -100.0, 100.0).func_181673_a(d0, d1 + 0.5).func_181675_d();
        worldrenderer.func_181662_b(100.0, -100.0, 100.0).func_181673_a(d0 + 0.3333333333333333, d1 + 0.5).func_181675_d();
        worldrenderer.func_181662_b(100.0, -100.0, -100.0).func_181673_a(d0 + 0.3333333333333333, d1).func_181675_d();
        tess.draw();
    }
