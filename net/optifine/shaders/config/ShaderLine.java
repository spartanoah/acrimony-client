...
public class ShaderLine {
    ...
    public boolean isConstBoolSuffix(String suffix, boolean val2) {
        return this.isConstBoolSuffix(suffix) && this.getValueBool() == val2;
    }
    ...
    public boolean isConstBool(String name, boolean val2) {
        return this.isConstBool(name) && this.getValueBool() == val2;
    }

    public boolean isConstBool(String name1, String name2, boolean val2) {
        return this.isConstBool(name1, name2) && this.getValueBool() == val2;
    }

    public boolean isConstBool(String name1, String name2, String name3, boolean val2) {
        return this.isConstBool(name1, name2, name3) && this.getValueBool() == val2;
    }
