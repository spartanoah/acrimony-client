...
Comparable<CharSequence> {
    ...
    public int lastIndexOf(CharSequence subString, int start) {
        ...
        byte firstCharAsByte = AsciiString.c2b0(firstChar);
        for (int i = this.offset + start; i >= 0; --i) {
            if (this.value[i] != firstCharAsByte) continue;
            int o1 = i;
            int o2 = 0;
            while (++o2 < subCount && AsciiString.b2c(this.value[++o1]) == subString.charAt(o2)) {
    ...
    public AsciiString replace(char oldChar, char newChar) {
        ...
        for (int i = this.offset; i < len; ++i) {
            ...
            byte[] buffer = PlatformDependent.allocateUninitializedArray((int)this.length());
    ...
    public AsciiString[] split(char delim) {
        int i;
        ArrayList res = InternalThreadLocalMap.get().arrayList();
        int start = 0;
    ...
    public boolean equals(Object obj) {
        ...
        return this.length() == other.length() && this.hashCode() == other.hashCode() && PlatformDependent.equals((byte[])this.array(), (int)this.arrayOffset(), (byte[])other.array(), (int)other.arrayOffset(), (int)this.length());
    }
    ...
    public static int hashCode(CharSequence value) {
        ...
        return PlatformDependent.hashCodeAscii((CharSequence)value);
    }
