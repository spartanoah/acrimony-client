...
extends MessageToMessageDecoder<DatagramPacket> {
    ...
    protected void decode(ChannelHandlerContext ctx, final DatagramPacket packet, List<Object> out) throws Exception {
        ...
        DnsMessageUtil.decodeDnsQuery(this.recordDecoder, buf, new DnsMessageUtil.DnsQueryFactory(){
    ...
    private static DnsQuery newQuery(DatagramPacket packet, ByteBuf buf) {
        ...
        DatagramDnsQuery query = new DatagramDnsQuery((InetSocketAddress)packet.sender(), (InetSocketAddress)packet.recipient(), id, DnsOpCode.valueOf((byte)(flags >> 11 & 0xF)));
