...
public enum ErrorCode {
    ...
    public static ErrorCode lookupValue(int n) {
        ErrorCode errorCode = s_Map.get(n);
        return errorCode;
    }
    ...
    public static boolean succeeded(ErrorCode errorCode) {
        return errorCode.getValue() <= TTV_EC_SUCCESS.getValue();
    }

    public static boolean failed(ErrorCode errorCode) {
        return errorCode.getValue() > TTV_EC_SUCCESS.getValue();
    }

    public static String getString(ErrorCode errorCode) {
        Core core = Core.getInstance();
        if (core == null) {
            return "Unknown error";
        }
        return core.errorToString(errorCode);
    }
    ...
    static {
        ...
        for (ErrorCode errorCode : enumSet) {
            s_Map.put(errorCode.getValue(), errorCode);
        }
    }
}
