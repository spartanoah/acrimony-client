...
public final class GL32 {
    ...
    public static void glGetMultisample(int pname, int index, FloatBuffer val2) {
        ...
        GL32.nglGetMultisamplefv(pname, index, MemoryUtil.getAddress(val2), function_pointer);
    }
    ...
    public static int glGetSynci(GLSync sync, int pname) {
        ...
        GL32.nglGetSynciv(sync.getPointer(), pname, 1, 0L, MemoryUtil.getAddress(values), function_pointer);
        return values.get(0);
    }
}
