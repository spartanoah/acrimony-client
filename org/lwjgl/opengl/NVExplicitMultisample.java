...
public final class NVExplicitMultisample {
    ...
    public static void glGetMultisampleNV(int pname, int index, FloatBuffer val2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetMultisamplefvNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(val2, 2);
        NVExplicitMultisample.nglGetMultisamplefvNV(pname, index, MemoryUtil.getAddress(val2), function_pointer);
    }
