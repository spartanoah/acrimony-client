...
public final class ARBShaderObjects {
    ...
    public static int glGetActiveUniformSizeARB(int programObj, int index) {
        ...
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, 0, 0L, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer);
        return size.get(0);
    }
    ...
    public static int glGetActiveUniformTypeARB(int programObj, int index) {
        ...
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, 0, 0L, MemoryUtil.getAddress(type, 1), MemoryUtil.getAddress(type), APIUtil.getBufferByte0(caps), function_pointer);
        return type.get(0);
    }
