        ...
        if (loggerFields != null) {
            for (LoggerFields lField : loggerFields) {
                ...
                for (Map.Entry<String, String> entry : fields.entrySet()) {
                    List formatters = fieldParser.parse(entry.getValue(), false);
