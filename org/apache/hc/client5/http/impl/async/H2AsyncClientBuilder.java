...
public class H2AsyncClientBuilder {
    ...
    public CloseableHttpAsyncClient build() {
        ...
        H2AsyncClientEventHandlerFactory ioEventHandlerFactory = new H2AsyncClientEventHandlerFactory(new DefaultHttpProcessor(new HttpRequestInterceptor[]{new H2RequestContent(), new H2RequestTargetHost(), new H2RequestConnControl()}), new HandlerFactory<AsyncPushConsumer>(){
        ...
        H2ConnPool connPool = new H2ConnPool((ConnectionInitiator)connectionInitiator, (Resolver)new Resolver<HttpHost, InetSocketAddress>(){
        ...
        closeablesCopy.add((Closeable)connPool);
