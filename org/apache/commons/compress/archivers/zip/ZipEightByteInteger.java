...
implements Serializable {
    ...
    public static byte[] getBytes(BigInteger value) {
        ...
        long val2 = value.longValue();
        result[0] = (byte)(val2 & 0xFFL);
        result[1] = (byte)((val2 & 0xFF00L) >> 8);
        result[2] = (byte)((val2 & 0xFF0000L) >> 16);
        result[3] = (byte)((val2 & 0xFF000000L) >> 24);
        result[4] = (byte)((val2 & 0xFF00000000L) >> 32);
        result[5] = (byte)((val2 & 0xFF0000000000L) >> 40);
        result[6] = (byte)((val2 & 0xFF000000000000L) >> 48);
        result[7] = (byte)((val2 & 0x7F00000000000000L) >> 56);
        if (value.testBit(63)) {
    ...
    public static BigInteger getValue(byte[] bytes, int offset) {
        ...
        BigInteger val2 = BigInteger.valueOf(value += (long)bytes[offset] & 0xFFL);
        return (bytes[offset + 7] & 0xFFFFFF80) == -128 ? val2.setBit(63) : val2;
    }
