...
extends HUDModule {
    private final ModeSetting mode = new ModeSetting("Mode", "Acrimony", "Acrimony", "Outline");
    ...
    protected void renderModule(boolean inChat) {
        boolean canRender;
        boolean bl = canRender = this.killauraModule.isEnabled() && this.killauraModule.getTarget() != null && this.killauraModule.getTarget() instanceof EntityPlayer || inChat;
