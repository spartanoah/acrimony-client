 ...
 */
package Acrimony.module.impl.visual.motionblur;
...
public class CustomShaderGroup
extends ShaderGroup {
    ...
    public void parseGroup(TextureManager p_152765_1_, ResourceLocation p_152765_2_) throws IOException, JsonSyntaxException {
        JsonObject jsonobject = Acrimony.instance.getModuleManager().getModule(CustomGui.class).getJsonObject();
