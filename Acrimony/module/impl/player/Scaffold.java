...
extends Module {
            ...
            block4 : switch (this.mode.getMode()) {
                ...
                case "Hypixel": {
                    switch (this.hypixelSprint.getMode()) {
                        ...
                        case "Semi": {
                            if (Scaffold.mc.thePlayer.onGround) {
                                if (this.ticksHovering != 0 || !KeyboardUtil.isPressed(Scaffold.mc.gameSettings.keyBindJump)) {
    ...
    public void onPacketSend(PacketSendEvent event) {
        ...
        if (event.getPacket() instanceof C08PacketPlayerBlockPlacement && (packet = (C08PacketPlayerBlockPlacement)event.getPacket()).getPlacedBlockDirection() != 255) {
            ...
            if (this.blockPlaceESP.isEnabled()) {
                int color = ClientTheme.color1.getRGB();
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        for (PlacedBlock block : toRemove) {
    ...
    public int getBlockSlot() {
        ...
        for (int i = 8; i >= 0; --i) {
            ...
            if (stack == null || !(stack.getItem() instanceof ItemBlock) || InventoryUtil.isBlockBlacklisted(stack.getItem()) || stack.stackSize < 3) continue;
            bestSlot = i;
