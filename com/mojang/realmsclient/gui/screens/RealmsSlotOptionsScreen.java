...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.pvpButton = RealmsSlotOptionsScreen.newButton(4, this.column2_x, RealmsConstants.row(2), this.column_width, 20, this.pvpTitle());
        this.buttonsAdd(this.pvpButton);
        this.buttonsAdd(RealmsSlotOptionsScreen.newButton(3, this.column1_x, RealmsConstants.row(4), this.column_width, 20, this.gameModeTitle()));
