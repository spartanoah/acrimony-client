...
public interface FlatClientProperties {
    ...
    public static final String POPUP_ROUNDED_BORDER_WIDTH = "Popup.roundedBorderWidth";
    ...
    public static final String TABBED_PANE_TAB_ROTATION = "JTabbedPane.tabRotation";
    public static final String TABBED_PANE_TAB_ROTATION_NONE = "none";
    public static final String TABBED_PANE_TAB_ROTATION_AUTO = "auto";
    public static final String TABBED_PANE_TAB_ROTATION_LEFT = "left";
    public static final String TABBED_PANE_TAB_ROTATION_RIGHT = "right";
