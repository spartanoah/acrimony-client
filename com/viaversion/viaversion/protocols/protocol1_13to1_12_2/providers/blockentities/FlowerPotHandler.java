...
implements BlockEntityProvider.BlockEntityHandler {
    ...
    public int transform(UserConnection user, CompoundTag tag) {
        ...
        Integer flower = flowers.get(new Pair<Object, Byte>(item = item instanceof String ? Key.stripMinecraftNamespace((String)item) : (item instanceof Number ? Byte.valueOf(((Number)item).byteValue()) : Byte.valueOf((byte)0)), (Byte)(data = data instanceof Number ? Byte.valueOf(((Number)data).byteValue()) : Byte.valueOf((byte)0))));
        if (flower != null) {
            return flower;
        }
