...
import com.viaversion.viaversion.libs.fastutil.io.MeasurableInputStream;
import com.viaversion.viaversion.libs.fastutil.io.MeasurableStream;
import com.viaversion.viaversion.libs.fastutil.io.RepositionableStream;
...
implements RepositionableStream {
    ...
    public int readLine(byte[] array, int off, int len, EnumSet<LineTerminator> terminators) throws IOException {
        ByteArrays.ensureOffsetLength((byte[])array, (int)off, (int)len);
        if (len == 0) {
            return 0;
        }
        if (this.noMoreCharacters()) {
