...
extends UFormat {
    ...
    public static final DateFormat getTimeInstance() {
        return DateFormat.get(-1, 2, ULocale.getDefault(ULocale.Category.FORMAT));
    }

    public static final DateFormat getTimeInstance(int style) {
        return DateFormat.get(-1, style, ULocale.getDefault(ULocale.Category.FORMAT));
    }
    ...
    public static final DateFormat getDateInstance() {
        return DateFormat.get(2, -1, ULocale.getDefault(ULocale.Category.FORMAT));
    }

    public static final DateFormat getDateInstance(int style) {
        return DateFormat.get(style, -1, ULocale.getDefault(ULocale.Category.FORMAT));
    }
    ...
    public static final DateFormat getDateTimeInstance() {
        return DateFormat.get(2, 2, ULocale.getDefault(ULocale.Category.FORMAT));
    }

    public static final DateFormat getDateTimeInstance(int dateStyle, int timeStyle) {
        return DateFormat.get(dateStyle, timeStyle, ULocale.getDefault(ULocale.Category.FORMAT));
    }
